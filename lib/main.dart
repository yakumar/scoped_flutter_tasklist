...
class _HomeState extends State<Home> {
        ...
        child: new Scaffold(
          ...
          body: new ListView(
              children: <Widget>[
                  ...
                  child: new Column(
                    children: <Widget>[
                      new Padding(
                        ...
                        child: new TextField(controller: _taskController, decoration: new InputDecoration(fillColor: Colors.lime),),
                      ),
                ...
                new Padding(padding: new EdgeInsets.fromLTRB(3.0, 10.0, 3.0, 8.0)),
                new ScopedModelDescendant<TaskList>(
                  builder: (context, child, model) {
                    return new ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return new Card(
                            elevation: 8.0,
                            color: Colors.lime,
                            child: new ListTile(title: new Text(model.taskList[index]),),
                          );
                        });
                  },
                ),
  ...
  void _addTasks(TaskList newMod) {
    ...
    newMod._addTo(_taskController.text);
